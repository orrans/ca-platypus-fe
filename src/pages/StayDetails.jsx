...
export function StayDetails() {
    ...
    const { checkIn, checkOut, guests = 1, nights, pricePerNight } = bookingState

    const totalPrice = nights && pricePerNight ? nights * pricePerNight : null
        ...
        <section className="stay-details">
            ...
            <section className="stay-location">
                ...
                <div className="location-map-container">
                    <GoogleMap 
                        stays={[stay]} 
                        fromDate={checkIn ? new Date(checkIn) : new Date()} 
                        toDate={checkOut ? new Date(checkOut) : new Date()}
                        variant="details"
                    />
                </div>
            </section>
